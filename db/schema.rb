...
ActiveRecord::Schema.define(version: 20140715052546) do
  ...
  create_table "league_memberships", force: true do |t|
    ...
    t.integer  "monthly_fa_pickups", default: 0
    t.integer  "season_fa_pickups",  default: 0
    t.text     "season_scores"
  end
  ...
  add_index "trades", ["league_id"], name: "index_trades_on_league_id", using: :btree
  ...
  add_index "weeks", ["end_time"], name: "index_weeks_on_end_time", using: :btree
  add_index "weeks", ["start_time"], name: "index_weeks_on_start_time", using: :btree
